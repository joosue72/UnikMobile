...
import 'package:path/path.dart' as s;
 ...
 class VistaCalidad extends StatefulWidget {
  final imgPath, title;

  VistaCalidad({this.imgPath, this.title});

  @override
  _VistaCalidadState createState() => _VistaCalidadState();
}
    ...
    Container(
       height: 100,
          ...
          child: CupertinoPicker(
            ...
            stream: db.collection('Calidad').where("Categoria", isEqualTo: selected).snapshots(),
